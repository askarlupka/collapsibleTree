...
if(length(new.packages)) remotes::install_github("askarlupka/collapsibleTree",
                        upgrade = "ask") #you can switch this to never after the initial install. I've had issues with three of my packages (rlang, stringi, htmltools) just not updating
